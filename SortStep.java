...
public class SortStep{
        ...
        do{
            ...
            if ('1' <= choice.charAt(0) && choice.charAt(0) <= '6'){
                ...
                switch (choice.charAt(0)){
                    ...
                    int searchFor = console.nextInt();
                    System.out.println(searchFor + " was found at location " 
                   + mySorts.sequentialSearch(myArray, searchFor) + ".");
                   System.out.println("This program counts location starting at 0.");
                   System.out.println("If the location is -1, your number was not found.");
                   break;
                   // case '7':
                    //resetArraySearch();
                    //System.out.print("What number are you searching for? ");
                    //int searchFor = console.nextInt();
                    //mySorts.binarySearch(myArray);
                    //break;
                }
    ...
    private void resetArraySearch(){
        if (myArray == null || listType.equals("Integer")){
            fillArrayWithIntsSearch();
        }
    ...
    private void fillArrayWithIntsSearch(){
